...
def classify_mfcc_image(image_path, label_encoder):
...
def classify_audio_segments(file_path, label_encoder):
    ...
    for i, (segment, sr) in enumerate(audio_segments):
        ...
        predicted_label = classify_mfcc_image(mfcc_image_path, label_encoder)
